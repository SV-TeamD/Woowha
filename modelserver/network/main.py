...
def get_args():
    ...
    parser.add_argument("--test", action="store_true", help="Use this argument to test generator")
    ...
    parser.add_argument(
        "--cartoon_image_dir",
        default=Config.cartoon_image_dir,
...
def main():
    ...
    if args.test:
        ...
        test_images = load_image_dataloader(
            root_dir=args.test_image_path, batch_size=args.batch_size * 2, shuffle=False
        )
        ...
        animation_images = load_image_dataloader(
            root_dir=args.cartoon_image_dir, batch_size=args.batch_size
        )
